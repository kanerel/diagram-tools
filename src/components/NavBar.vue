<template>
  <nav class="navbar">
    ...
    <div class="navbar-actions">
      <button class="navbar-theme" @click="$emit('toggleTheme')" :title="isDark ? '切换亮色主题' : '切换暗色主题'">
        <!-- Moon icon (dark mode) -->
      ...
      <a class="navbar-github" href="https://github.com/kanerel/diagram-tools" target="_blank" rel="noopener" title="GitHub">
...
const navRoutes = [
  ...
  },
  {
    path: '/sql-to-table',
    label: 'SQL to Table',
    icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="15" x2="21" y2="15"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/></svg>'
  },
  {
    path: '/use-case',
    label: 'Use Case',
    icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="3"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="11" x2="16" y2="11"/><line x1="12" y1="16" x2="8" y2="22"/><line x1="12" y1="16" x2="16" y2="22"/></svg>'
  },
  {
    path: '/system-module',
    label: 'System Module',
  ...
  },
  {
    path: '/flowchart',
    label: 'FlowChart',
    icon: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="12" y1="8" x2="12" y2="16"/><polyline points="9 11 12 8 15 11"/></svg>'
  },
  {
    path: '/mermaid',
    label: 'Mermaid',
